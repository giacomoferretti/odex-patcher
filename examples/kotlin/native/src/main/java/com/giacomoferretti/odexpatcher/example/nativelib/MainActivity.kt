package com.giacomoferretti.odexpatcher.example.nativelib
...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textView = TextView(this).apply {
            gravity = Gravity.CENTER
            text = getBuildConfigString("EXAMPLE_TEXT") + getRunningAbi()
    ...
    external fun getRunningAbi(): String
    external fun getBuildConfigString(name: String): String
